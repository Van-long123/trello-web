...
import { inviteUserToBoardToApi } from '~/apis'
...
function InviteBoardUser({ boardId }) {
  ...
  */
  ...
  const submitInviteUserToBoard = (data) => {
    ...
    // Gọi api mời một người dùng vào làm thành viên của board
    inviteUserToBoardToApi({ inviteeEmail, boardId }).then(invitation => {
